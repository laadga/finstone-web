...
export function AnimatedCard({ className, ...props }: CardProps) {
  return (
    <div
      ...
      className={cn(
        "group/animated-card relative w-[356px] overflow-hidden rounded-xl shadow-sm",
        className
      )}
      style={{ background: 'linear-gradient(to bottom right, rgb(219 234 254), rgb(239 246 255), rgb(229 231 235))' }}
      {...props}
    />
  );
}
  ...
  return (
    <>
      ...
      <div className="relative h-[180px] w-[356px] overflow-hidden rounded-t-lg">
        ...
        />
        <Layer2 color={mainColor} hoverText={hoverText} hoverSubtext={hoverSubtext} />
...
const Layer2: React.FC<{ color: string; hoverText?: string; hoverSubtext?: string }> = ({ color, hoverText = "Process Analysis Complete", hoverSubtext = "Identifying automation opportunities" }) => {
  return (
    <div
...
const Layer4: React.FC<LayerProps & { floatingItems?: Array<{ id: number; translateX: string; translateY: string; text: string; }> }> = ({ color, secondaryColor, hovered, floatingItems }) => {
  const items = floatingItems || [
    { id: 1, translateX: "100", translateY: "50", text: "Process Audit" },
    { id: 2, translateX: "100", translateY: "-50", text: "Strategy" },
    { id: 3, translateX: "125", translateY: "0", text: "Analysis" },
    { id: 4, translateX: "-125", translateY: "0", text: "Development" },
    { id: 5, translateX: "-100", translateY: "50", text: "Deployment" },
    { id: 6, translateX: "-100", translateY: "-50", text: "Integration" },
  ];
