...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/auth-demo?message=Account created successfully! Please sign in.');
    } catch (err) {
  ...
  const handleSocialSignup = (provider: string) => {
    ...
    switch (provider) {
      ...
      case 'apple':
        ...
        break;
      case 'github':
        alert('GitHub OAuth setup required. Opening GitHub signup...');
        ...
        <div className="mx-auto space-y-4 max-w-sm">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="text-muted-foreground text-base">
              Join Finstone and start building with AI
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth-demo" className="text-blue-600 hover:text-blue-500 font-medium">
                Log in
              </Link>
            </p>
          </div>
