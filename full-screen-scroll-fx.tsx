...
export const FullScreenScrollFX = forwardRef<HTMLDivElement, FullScreenFXProps>(
  (
    ...
    const cssVars: CSSProperties = {
      ...
      ["--fx-text" as any]: colors.text ?? "rgba(11, 28, 44, 0.95)",
      ["--fx-overlay" as any]: colors.overlay ?? "rgba(0,0,0,0.2)",
      ["--fx-page-bg" as any]: colors.pageBg ?? "#f8f9fa",
    ...
    return (
      ...
      >
        ...
        <style jsx>{`
          ...
          .fx-progress { width: 200px; height: 2px; margin: 1rem auto 0; background: rgba(11, 28, 44, 0.28); position: relative; }
