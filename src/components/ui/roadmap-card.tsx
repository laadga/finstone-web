...
export function RoadmapCard({
  ...
  return (
    <Card className="w-full max-w-6xl shadow-2xl border border-white/30 bg-transparent">
      ...
      <CardContent className="bg-transparent">
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-0 right-0 top-4 h-px bg-gray-300" />
          ...
          {items.map((item, index) => (
              ...
              >
                ...
                {/* Title + Description */}
                <h4 className="text-sm font-medium text-navy-900">{item.title}</h4>
